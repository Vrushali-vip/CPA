...
//         if (activePage === "XPO Services Dashboard") {
...
//             setMonthlyData([]);
//         }
//     }, [client, selectedDateFilter, selectedProcess, logs, setHourlyData, setWeeklyData, setMonthlyData]);
...
//                     <li
//                         className={`cursor-pointer ${activePage === "XPO Services Dashboard" ? "text-primary" : "text-white"}`}
//                         onClick={() => {
