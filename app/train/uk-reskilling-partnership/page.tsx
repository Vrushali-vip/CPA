...
// Define Prices based on Tabs AND Levels (adjust these prices as needed)
// Structure: { TabName: { LevelName: PriceString, ... }, ... }
const PRICES = {
  ...
  [TABS[2]]: { // In-person Training Prices
    [LEVELS[0]]: "1200€ total", // Beginner (Example: one-time fee)
    [LEVELS[1]]: "1500€ total", // Intermediate
    [LEVELS[2]]: "1800€ total", // Advanced
  },
};
...
export default function ReskillingHub() {
  ...
  return (
    <main className="flex flex-col justify-center items-center min-h-screen px-4 mt-12 text-white">
      ...
      {/* ----- Customized For You Section (MODIFIED with Level-Specific Pricing)----- */}
      <section className="w-full py-12 px-4 mt-16">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-center text-3xl font-bold mb-8">
            Customized for you
