    ...
    <main>
      ...
      <section className="p-4 md:p-8 lg:p-12 xl:p-16 mx-auto bg-al-1000 min-h-screen flex items-center">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-center text-xl">(Through value/impact obsession)</p>
            ...
            {[
              {
                src: "/nhs_white.png",
                alt: "NHS",
                text: "Automating repetitive tasks for administering patients across a large NHS teaching hospitals."
              },
              {
                src: "/xpo_white.png",
                alt: "XPO Logistics",
                text: "Automating customs import processes for one of the world's largest logistics companies."
              },
              {
                src: "/allcare_white.png",
                alt: "Allcare Pharmaceuticals",
                text: "Cara/Allcare Pharmacy: Automating drug invoicing for Irish Care Homes"
              },
              {
                src: "/alphabot_white.png",
                alt: "Alphabot",
                text: "AI reads & automates Penalty Notice processing for 100+ UK councils."
              },
            ].map((item, idx) => (
              <div key={idx} className="grid items-center justify-center p-2 rounded-lg shadow-md">
                <Image src={item.src} width={150} height={200} className="mx-auto" alt={item.alt} />
                <p className="text-sm pt-2 text-center">{item.text}</p>
              </div>
            ))}
          </div>
        </div>
