  ...
  return (
    <footer>
      ...
      <div className="mx-auto max-w-6xl py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap gap-8 justify-center my-24">
          <div
            className="bg-white border rounded-full w-32 h-32 grid place-items-center p-2 overflow-hidden"
          ...
          <div
            className="bg-white border rounded-full w-32 h-32 grid place-items-center p-2 overflow-hidden"
            title="HM Government G-Cloud Supplier"
          >
            <Image
              src="/g-cloud-logo.svg"
              width={200}
              height={200}
              className="object-contain"
          ...
          <div
            className="bg-white border rounded-full w-32 h-32 grid place-items-center p-4 overflow-hidden"
            title="NHS Digital"
          >
            <Image
              src="/nhs-bg.png"
          ...
          <div
            className="bg-white border rounded-full w-32 h-32 grid place-items-center p-4 overflow-hidden"
            title="Information Commissioner's Office Registered"
          >
            <Image
              src="/ico.png"
              width={200}
          ...
          <div
            className="bg-white border rounded-full w-32 h-32 grid place-items-center p-2 overflow-hidden"
            title="Robocorp Tier 1 Partner"
          >
            <Image
              src="/robocorp-partner.png"
              width={200}
              height={200}
              className="object-contain"
              alt="Robocorp Tier 1 Partner"
            />
          </div>
          <div
            className="bg-white border rounded-full w-32 h-32 grid place-items-center p-2 overflow-hidden"
            title="Workato Gold Partner"
          >
            <Image
              src="/workato-gold.png"
              width={200}
              height={200}
              className="object-contain"
              alt="Workato Gold Partner"
            />
          </div>
          <div
            className="bg-white border rounded-full w-32 h-32 grid place-items-center p-2 overflow-hidden"
        ...
        <div className="flex justify-between flex-wrap mb-4">
          <div className="flex gap-3 text-sm flex-wrap text-muted-foreground">
            <Link className="hover:text-primary" href="https://alphalake.ai" target="_blank">
              Alphalake Technologies
            </Link>
            <Link className="hover:text-primary" href="#">Sitemap</Link>
          ...
          <div className="flex gap-3 flex-wrap">
            ...
            <Link
              className="p-1 rounded-md hover:bg-primary-foreground hover:text-primary"
              target="_blank"
              href="https://www.linkedin.com/company/alphalake/"
            >
              <LinkedinIcon />
            </Link>
            <Link
              className="p-1 rounded-md hover:bg-primary-foreground hover:text-primary"
              target="_blank"
              href="https://www.youtube.com/channel/UCCOu5vcJ6AZ-lkTs3s7-YKA"
            >
              <YoutubeIcon />
            </Link>
          </div>
        ...
        <div className="text-center font-robo text-muted-foreground space-y-4 pt-4">
          ...
          <p>
            <span className="text-2xl">&copy;</span> {new Date().getFullYear()} Alphalake Technologies Ltd.
            All Rights Reserved.
          </p>
        </div>
      </div>
