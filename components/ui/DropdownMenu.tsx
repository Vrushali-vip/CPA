...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm font-medium outline-none focus:bg-[#00BBD3] focus:text-white data-[state=open]:bg-[#00BBD3] data-[state=open]:text-white",
      inset && "pl-8",
      className
    )}
    {...props}
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center px-2 py-1.5 text-sm outline-none transition-colors focus:bg-[#00BBD3] focus:text-white hover:bg-[#00BBD3] hover:text-white",
      inset && "pl-8",
      className
    )}
    {...props}
